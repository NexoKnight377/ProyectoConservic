                                ...
                                <div class="px-30">
                                    <div class="block block-themed block-rounded block-shadow">
                                        <div class="block-header bg-gd-sun">
                                            <h1 class="block-title" style="color:black;font-size: 20px;">Registrese para usar su Herramienta de Gestión</h1>
                                        </div>
                                        <div class="block-content">
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_nom">Nombre</label>
                                                    <input type="text" class="form-control" id="usuario_nom" name="usuario_nom" placeholder="ej: Luis" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_ape">Apellido</label>
                                                    <input type="text" class="form-control" id="usuario_ape" name="usuario_ape" placeholder="ej: Perez" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_correo">Correo</label>
                                                    <input type="email" class="form-control" id="usuario_correo" name="usuario_correo" placeholder="ej: usuario29@correo.com" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_usu">Usuario</label>
                                                    <input type="text" class="form-control" id="usuario_usu" name="usuario_usu" placeholder="ej: usuario29" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_pass">Contraseña</label>
                                                    <input type="password" class="form-control" id="usuario_pass" name="usuario_pass" placeholder="********" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="usuario_pass_confirm">Confirmar Contraseña</label>
                                                    <input type="password" class="form-control" id="usuario_pass_confirm" name="usuario_pass_confirm" placeholder="********" required>
                                                </div>
                                            </div>
