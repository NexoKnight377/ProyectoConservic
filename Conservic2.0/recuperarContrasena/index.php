                            ...
                            <div class="content content-full overflow-hidden">
                                ...
                                <div class="py-30 text-center">
                                    <a class="link-effect font-w700" href="index.html">
                                        <i class="si si-fire" style="color:orange;"></i>
                                        <span class="font-size-xl text-black">Cons</span><span class="font-size-xl text-warning">ervic</span>
                                    </a>
                                    <h1 class="h4 font-w700 mt-30 mb-10 text-white">Recuperar Contraseña</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0 text-white">Ups!... Parece que Alguien olvido la clave 0_o</h2>
                                </div>
                                <form class="js-validation-signup" action="be_pages_auth_all.html" method="post">
                                    <div class="block block-themed block-rounded block-shadow">
                                        <div class="block-header bg-gd-sun">
                                            <h3 class="block-title">Ingrese su Correo para Recuperar su Cuenta</h3>
                                        ...
                                        <div class="block-content">
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="email" class="form-control" id="signup-email" name="signup-email" placeholder="ej: john@correo.com">
                                                </div>
                                            </div>
